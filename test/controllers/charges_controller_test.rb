...
class ChargesControllerTest < ActionController::TestCase
  ...
  test "should create charge" do
    assert_difference('Charge.count') do
      post :create, charge: { amount: @charge.amount, created: @charge.created, currency: @charge.currency, paid: @charge.paid, refunded: @charge.refunded }
    end
  ...
  test "should update charge" do
    patch :update, id: @charge, charge: { amount: @charge.amount, created: @charge.created, currency: @charge.currency, paid: @charge.paid, refunded: @charge.refunded }
    assert_redirected_to charge_path(assigns(:charge))
  end
